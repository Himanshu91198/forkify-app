...
ey=function(e,t){var r,n;if("string"===t&&Q(r=e.toString)&&!Y(n=$(r,e))||Q(r=e.valueOf)&&!Y(n=$(r,e))||"string"!==t&&Q(r=e.toString)&&!Y(n=$(r,e)))return n;throw new eb("Can't convert object to primitive value")};var e_={},ew={};ew=!1;var ek={},eE={},eS=Object.defineProperty;eE=function(e,t){try{eS(k,e,{value:t,configurable:!0,writable:!0})}catch(r){k[e]=t}return t};var eF="__core-js_shared__";ek=k[eF]||eE(eF,{}),(e_=function(e,t){return ek[e]||(ek[e]=void 0!==t?t:{})})("versions",[]).push({version:"3.33.1",mode:ew?"pure":"global",copyright:"\xa9 2014-2023 Denis Pushkarev (zloirock.ru)",license:"https://github.com/zloirock/core-js/blob/v3.33.1/LICENSE",source:"https://github.com/zloirock/core-js"});var e$={},ej={},eO=Object;// `ToObject` abstract operation
...
J=function(e,t){if(!Y(e)||ee(e))return e;var r,n=ef(e,eN);if(n){if(void 0===t&&(t="default"),r=$(n,e,t),!Y(r)||ee(r))return r;throw new eq("Can't convert object to primitive value")}return void 0===t&&(t="number"),ey(e,t)},// `ToPropertyKey` abstract operation
...
tB="object"==typeof Reflect&&Reflect.apply||(j?tQ.bind(tY):function(){return tQ.apply(tY,arguments)});var tV={},tK={},tX=(tK=function(e){// Nashorn bug:
//   https://github.com/zloirock/core-js/issues/1128
//   https://github.com/zloirock/core-js/issues/1130
if("Function"===N(e))return A(e)})(tK.bind);// optional / simple context binding
tV=function(e,t){return eh(e),void 0===t?e:j?tX(e,t):function(){return e.apply(t,arguments)}};var tZ={};tZ=et("document","documentElement");var t0={};t0=A([].slice);var t1={},t2=TypeError;t1=function(e,t){if(e<t)throw new t2("Not enough arguments");return e};var t4={};// eslint-disable-next-line redos/no-vulnerable -- safe
...
k.postMessage(rt(e),h.protocol+"//"+h.host)};t3&&t9||(t3=function(e){t1(arguments.length,1);var t=Q(e)?e:t6(e),r=t0(arguments,1);return rn[++rr]=function(){tB(t,void 0,r)},v(rr),rr},t9=function(e){delete rn[e]},t5?v=function(e){t7.nextTick(ra(e))}:t8&&t8.now?v=function(e){t8.now(ra(e))}:re&&!t4?(m=(g=new re).port2,g.port1.onmessage=rs,v=tV(m.postMessage,m)):k.addEventListener&&Q(k.postMessage)&&!k.importScripts&&h&&"file:"!==h.protocol&&!F(rc)?(v=rc,k.addEventListener("message",rs,!1)):v=ri in eD("script")?function(e){tZ.appendChild(eD("script"))[ri]=function(){tZ.removeChild(this),ro(e)}}:function(e){setTimeout(ra(e),0)});var ru=(tU={set:t3,clear:t9}).clear;// `clearImmediate` method
...
let t=r_.bookmarks.findIndex(t=>t.id===e);r_.bookmarks.splice(t,1),e===r_.recipe.id&&(r_.recipe.bookmarked=!1),r$()};!function(){let e=localStorage.getItem("bookmarks");e&&(r_.bookmarks=JSON.parse(e))}();const rL=async function(e){try{let t=Object.entries(e).filter(e=>e[0].startsWith("ingredient")&&""!==e[1]).map(e=>{let t=e[1].split(",").map(e=>e.trim());// const ingArr = ing[1].replaceAll(' ', '').split(',');
if(3!==t.length)throw Error("Wrong ingredient fromat! Please use the correct format :)");let[r,n,i]=t;return{quantity:r?+r:null,unit:n,description:i}}),r={title:e.title,source_url:e.sourceUrl,image_url:e.image,publisher:e.publisher,cooking_time:+e.cookingTime,servings:+e.servings,ingredients:t},n=await rb(`${rm}?key=${ry}`,r);r_.recipe=rw(n),rj(r_.recipe)}catch(e){throw e}};var rM={};rM=new URL("icons.c14567a0.svg",import.meta.url).toString();class rP{_data;/**
...
return 1!=t&&r.push(t),r;// Return the prime factors
  ...
  `}}var rT=new rx;class rA{_parentEl=document.querySelector(".search");getQuery(){let e=this._parentEl.querySelector(".search__field").value;return this._clearInput(),e}_clearInput(){this._parentEl.querySelector(".search__field").value=""}addHandlerSearch(e){this._parentEl.addEventListener("submit",function(t){t.preventDefault(),e()})}}var rH=new rA,rI=new class extends rP{_parentElement="";_generateMarkup(){let e=window.location.hash.slice(1);return`
      <li class="preview">
...
await rL(e),console.log(r_.recipe),rT.render(r_.recipe),rG.renderMessage(),rW.render(r_.bookmarks),// Change ID in URL
window.history.pushState(null,"",`#${r_.recipe.id}`),// Close form window
setTimeout(function(){rG.toggleWindow()},2500)}catch(e){console.error("\uD83D\uDCA5",e),rG.renderError(e.message)}};rW.addHandlerRender(function(){rW.render(r_.bookmarks)}),rT.addHandlerRender(rU),rT.addHandlerUpdateServings(function(e){// Update the recipe servings (in state)
rF(e),rT.update(r_.recipe)}),rT.addHandlerAddBookmark(function(){r_.recipe.bookmarked?rO(r_.recipe.id):rj(r_.recipe),rT.update(r_.recipe),rW.render(r_.bookmarks)}),rH.addHandlerSearch(rB),rD.addHandlerClick(function(e){rN.render(rS(e)),rD.render(r_.search)}),rG.addHandlerUpload(rJ);//# sourceMappingURL=index.43b8bf56.js.map

//# sourceMappingURL=index.43b8bf56.js.map
